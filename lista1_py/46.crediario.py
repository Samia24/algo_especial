...
#Entrada
valor = int(input('Informe o valor da mercadoria: '))

#Processamento
prest_1 = valor // 3
prest_2 = prest_1
entrada = valor - (prest_1 + prest_2)

#Saída
print(f'\n>>> O valor da entrada é de R${entrada:.2f} e das parcelas, 2x de R${prest_1:.2f}, correspondente ao valor da mercadoria que é R${valor:.2f}.')