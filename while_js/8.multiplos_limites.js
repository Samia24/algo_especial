//7.Peça ao usuário limite inferior, limite superior e então um número. Mostre cada número entre inferior e superior, inclusive, que seja múltiplo de número.

import { question } from "readline-sync";

function main() {
  const limite_inferior = obter_numero('Informe um limite inferior de uma faixa numérica: ')
  const limite_superior = obter_numero_minimo('Agora informe o limite superior (maior que o inferior): ', limite_inferior)
